...
public class FeedbackController {
	...
	public List<Feedback> getFeedbackByRatings(@PathVariable("ratings") float ratings) {

		return service.getFeedbackByRatings(ratings);
	}

	@GetMapping("/feedbacksCity/{city}")
	public List<Feedback> getFeedbackByCity(@PathVariable("city") String city) {

		return service.getFeedbackByCity(city);
	}

	@GetMapping("/feedbacksFeedback/{feedback}")
	public List<Feedback> getFeedbackByFeedback(@PathVariable("feedback") String feedback) {
